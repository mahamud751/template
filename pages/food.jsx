      ...
      <div id="page_wrapper">
        ...
        <div className="full-row bg-secondary pb-0">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://vegeatfoods.com/mt-content/uploads/2019/03/vegeat-burger-xl.jpg)",
              height: "100vh",
          ...
          >
            <header className="creative-header fixed-bg-secondary nav-on-banner">
                ...
                <nav className="navbar navbar-expand-lg nav-general nav-primary-hover nav-down-line-active">
                  ...
                  <div className="collapse navbar-collapse navbar-slide-push transation-this bg-white shadow-sm">
                    ...
                    <div className="mt-4 mb-3">
                      <ul>
                        <li className="mb-4">
                          <strong className="font-mini text-light">
                            PHONE:
                          </strong>
                          <br />
                    ...
                    <div className="col-md-12">
                      <nav className="navbar navbar-expand-lg nav-white nav-primary-hover nav-line-active py-2">
                        ...
                        >
                          ...
                          <a
                            href="#"
                            className="ms-2 btn btn-primary sm-mx-none"
                          >
                            Contact Us
                          </a>
                        </div>
                  ...
                  <div className="col-lg-7 col-md-7">
                    ...
                    <div className="text-extra1 mb-30">
                      <p className="text-white">
                        Fast delivery, deals & discounts and the best choice of
                        restaurants. Order now! Delicious meals delivered fresh
                        to your door. Browse our menu & order online! Online
                        Grocery shopping. Easy ordering process. 2000+
                        restaurants. 25+ cuisines. Delivery within minutes.
                      </p>
                    </div>
              ...
              <div className="row">
                <div className="col-md-7">
                  <div className="project-item mt-5 hover-img-zoom transation">
                    <div className="overflow-hidden transation img-area">
                      <img
                        src="https://i.ibb.co/mypCmKM/586effd480585f5ac3be0c7e8fca1311-removebg-preview.png"
                        alt="portfolio"
                      />
                    </div>
                    <div className="mt-4">
                ...
                <div className="col-md-5">
                  <div className="project-item mt-5 hover-img-zoom transation">
                    <div className="overflow-hidden transation img-area">
                      <img
                        src="https://i.ibb.co/gW5S0MW/tangerine-newt-TN09y-TRft-Z8-unsplash-1.png"
                        alt="portfolio"
                        style={{ height: "400px" }}
                      />
                    </div>
